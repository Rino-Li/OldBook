package cn.edu.uzz.activity.book.cn.edu.uzz.activity.book.adapter;
...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            ...
            holder.tv_name = (TextView) arg1.findViewById(R.id.item_typename);
            arg1.setTag(holder);
        } else {
        ...
        if (arg0 == selectItem) {
            ...
            holder.tv_name.setTextColor(context.getResources().getColor(R.color.standardgreen));
        } else {
